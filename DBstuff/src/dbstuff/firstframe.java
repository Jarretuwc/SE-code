...
public class firstframe extends javax.swing.JFrame {
    ...
    private void employeetableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_employeetableMouseClicked
        ...
        String tblID = tblModel.getValueAt(employeetable.getSelectedRow(), 2).toString();
        String tblUser = tblModel.getValueAt(employeetable.getSelectedRow(), 0).toString();
        String tblPass = tblModel.getValueAt(employeetable.getSelectedRow(), 1).toString();
